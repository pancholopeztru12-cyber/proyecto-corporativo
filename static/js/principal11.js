...
// Registros de prueba idénticos a los de tu HTML original
const registrosDemo = [
    { nombre: "Dato de Prueba 01", descripcion: "Este es un registro de relleno para cumplir la rúbrica", estado: "Activo" },
    { nombre: "Dato de Prueba 02", descripcion: "Otro registro simulado sin conexión a BD", estado: "Inactivo" }
];
...
// Oculta o muestra el botón "+ Agregar Nuevo Registro"
...
// Dibuja la tabla dinámica respetando tus estilos originales
function renderizarTabla(data) {
    ...
    tabla.innerHTML = data.map((item, index) => {
        const idSimulado = index + 1; // Genera ID consecutivo: 1, 2...
        ...
        if (response.ok) {
            ...
            if (menuPrincipal1.length > 0) {
                ...
                menuPrincipal1.forEach(nombre => {
                    ...
                    const style = (nombre === 'Principal 1.1') ? 'color: #4f46e5; font-weight: bold; text-decoration: none;' : 'color: #cbd5e1; text-decoration: none;';
